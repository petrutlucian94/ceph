...
struct cls_lock_lock_op
{
  ...
  cls_lock_lock_op() : type(C_LOCK_NONE), flags(0) {}
...
struct cls_lock_get_info_reply
{
  ...
  cls_lock_get_info_reply() : lock_type(C_LOCK_NONE) {}
...
struct cls_lock_assert_op
{
  ...
  cls_lock_assert_op() : type(C_LOCK_NONE) {}
...
struct cls_lock_set_cookie_op
{
  ...
  cls_lock_set_cookie_op() : type(C_LOCK_NONE) {}
