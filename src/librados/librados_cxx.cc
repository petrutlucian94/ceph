				    ...
				    struct timeval * duration, uint8_t flags)
{
  ...
  return rados::cls::lock::lock(this, oid, name, C_LOCK_EXCLUSIVE, cookie, "",
				 ...
				 struct timeval * duration, uint8_t flags)
{
  ...
  return rados::cls::lock::lock(this, oid, name, C_LOCK_SHARED, cookie, tag,
		  		description, dur, flags);
}
